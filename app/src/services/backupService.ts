 ...
 */
function mergeBookMetadata(current: Book, backup: Book): Book {
 ...
 */
async function createBackupZipToFile(
  appService: AppService,
  filePath: string,
  onProgress?: ProgressCallback,
): Promise<void> {
 ...
 */
function validateBackupStructure(entryNames: string[]): boolean {
